...
namespace property_types
{
    ...
    public partial class ExtensibleEnumClient
    {
        ...
        public virtual async Task<Response<ExtensibleEnumProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ExtensibleEnumClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ExtensibleEnumProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ExtensibleEnumClient.GetValue");
            scope.Start();
            try
        ...
        /// <param name="body"> The ExtensibleEnumProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
