...
namespace property_types
{
    ...
    public partial class ModelClient
    {
        ...
        public ModelClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public ModelClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
        ...
        public virtual async Task<Response<ModelProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ModelClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ModelProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ModelClient.GetValue");
            scope.Start();
            try
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("ModelClient.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="body"> The ModelProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ModelClient.Put");
            scope.Start();
            try
            {
