...
namespace property_types
{
    ...
    public partial class CollectionsStringClient
    {
        ...
        public virtual async Task<Response<CollectionsStringProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsStringClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CollectionsStringProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsStringClient.GetValue");
            scope.Start();
            try
        ...
        /// <param name="body"> The CollectionsStringProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
