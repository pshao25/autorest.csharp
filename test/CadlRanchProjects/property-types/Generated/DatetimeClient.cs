...
namespace property_types
{
    ...
    public partial class DatetimeClient
    {
        ...
        public virtual async Task<Response<DatetimeProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("DatetimeClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DatetimeProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("DatetimeClient.GetValue");
            scope.Start();
            try
