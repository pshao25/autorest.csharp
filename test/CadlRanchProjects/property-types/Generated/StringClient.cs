...
namespace property_types
{
    ...
    public partial class StringClient
    {
        ...
        public StringClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public StringClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
        ...
        public virtual async Task<Response<StringProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("StringClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<StringProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("StringClient.GetValue");
            scope.Start();
            try
        ...
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("StringClient.Put");
            scope.Start();
            try
            {
